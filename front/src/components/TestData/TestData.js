...
export default {
    ...
    methods: {
        ...
        getData: function() {
            let self = this;
            axios.get(self.SERVER_URL() + 'testing-data/' + self.projectId + "/" + self.runId + "/" + self.currentPage, self.getHeader(self))
        ...
        uploadTestDataSetClicked: function() {
            ...
            axios.post(this.SERVER_URL() + 'upload-test-data/' + this.projectId, form_data, this.getHeader(this))
                    .then(function(response) {  
        ...
        download: function() {
            ...
            axios.get(self.SERVER_URL() + 'get-test-set/' + self.projectId, header)
                    .then(function(response) {
                        let fileURL = window.URL.createObjectURL(new Blob([response.data]));
                        let fileLink = document.createElement('a');

                        fileLink.href = fileURL;
                        fileLink.setAttribute('download', "test_" + self.projectId + '.zip');
        ...
        runChanged: function(event) {
            ...
            this.$router.push({name: 'TestData', params: {project_id: this.projectId, run_id: run_id,}});
