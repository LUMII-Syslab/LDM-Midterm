<template>
	<div>
		...
		<div class="modal" id="train-data-modal">
			<div class="modal-dialog">
				<div class="modal-content">

					<div class="modal-header">
						<h4 class="modal-title">Upload training data</h4>
			...
			<div class="tab-content">
				<div class="tab-pane fade show active" id="tab-data">
					...
					<ul class="nav nav-tabs" id="myTab" role="tablist">
						<li class="nav-item">
							<router-link id="training-data-tab" :to="{ name: 'TrainingData', params: {project_id: projectId }}" data-toggle="tab" class="nav-link active" role="tab" aria-controls="training-data" aria-selected="true">
							Training data
							</router-link>
						</li>
						...
						<li class="nav-item">
							<router-link id="test-data-tab" data-toggle="tab" class="nav-link" :to="{ name: 'TestData', params: {project_id: projectId }}" role="tab" aria-controls="test-data" aria-selected="false">
							Test data
							</router-link>
						</li>
					</ul>
					...
					<div class="tab-content" id="myTabContent">
						<div class="tab-pane fade show active" id="training-data" role="tabpanel" aria-labelledby="home-tab">
							<div class="card shadow mb-4 col mr-2aaa "> 
								<div class="card-body">
							            ...
							            <div class="col-sm-9">                
							                <div class="row">
							                    <div class="col" v-for="p in images">
							                        ...
							                        <div class="mb-3">{{p.class}}</div>
							                        <!-- <div>File: {{p.name}}</div> -->

<!-- 						                            <div class="mb-3">
						                            	<span class="font-weight-bolder1">File: </span>{{p.name}}
						                            </div> -->
							                    </div>
							                </div>
