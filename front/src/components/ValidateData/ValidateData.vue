			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-header">
						<h4 class="modal-title">Upload validation data</h4>
					...
					<div class="modal-footer">
						<button type="button" class="btn btn-primary" data-dismiss="modal" @click="uploadValidationDataSetClicked">Upload</button>
			...
			<div class="tab-content">
				<div class="tab-pane fade show active" id="tab-data">
					...
					<ul class="nav nav-tabs" id="myTab" role="tablist">
						...
						<li class="nav-item">
							<router-link id="validate-data-tab" data-toggle="tab" class="nav-link active" :to="{ name: 'ValidateData', params: {project_id: projectId }}" role="tab" aria-controls="test-data" aria-selected="true">
							Validation data
							</router-link>
						</li>

						<li class="nav-item">
							<router-link id="test-data-tab" data-toggle="tab" class="nav-link" :to="{ name: 'TestData', params: {project_id: projectId }}" role="tab" aria-controls="test-data" aria-selected="true">
							Test data
							</router-link>
						</li>
					</ul>
